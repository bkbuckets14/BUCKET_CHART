...
def get_team_players(
    ...
    date_from: Optional[date] = Query(
        None, description="Only players with a shot on/after this date"
    ),
    date_to: Optional[date] = Query(
        None, description="Only players with a shot on/before this date"
    ),
):
    """
...
def get_shots(
    ...
    team_id: int = Query(
        ..., description="Team ID the player was on for these shots (required)"
    ),
